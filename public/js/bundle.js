...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // create marker element
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.success) {
              (0, _alert.showAlert)('success', 'You are successfuly logged In');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.success) {
              (0, _alert.showAlert)('success', 'Account has been update');
            }
...
var stripe = Stripe('pk_test_51GxJNpBTuxm47TYAKadvPK6d4TdXLbSDvdImWIXoPZwVnIAUFALV1hm47TG6goZZpnBvOEMM6flBWNGHFiDUiGNU00Q8eMlxxo');
...
var logoutBtn = document.querySelector('.nav__el--logout'); // Map
